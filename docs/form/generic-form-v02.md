...
Perfect — since we already covered **conditional logic**, now let’s step back and write a **complete documentation for your Form Engine**. This will serve as a reference for both developers and configuration authors.
Perfect! Let’s update the **guiding documentation** to include **repeatable fields**, `moreLabel`, and conditional rendering inside repeatable groups. Here’s the full updated version:
...
| `color`           | Primary theme color for inputs and labels | `"var(--colorBlue)"` |
